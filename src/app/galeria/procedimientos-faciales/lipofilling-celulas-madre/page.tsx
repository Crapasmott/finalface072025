...
// COMPONENTE PRINCIPAL DE LIPOFILLING
const LipofillingPage = () => {
  const [selectedCase, setSelectedCase] = useState(0);
  const [selectedImage, setSelectedImage] = useState(0);
  const [currentSlide, setCurrentSlide] = useState(0);

  // Datos de los 26 casos de Lipofilling con Células Madre
  const lipofillingCases = [
    {
      id: 1,
      title: "Lipofilling Facial con Células Madre",
      age: "40 años",
      description: "Relleno con grasa propia enriquecida con células madre para restaurar volumen facial y rejuvenecer.",
      images: [
        { before: "/images/lipofilling/caso1/frontal-antes.jpg", after: "/images/lipofilling/caso1/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/lipofilling/caso1/perfil-antes.jpg", after: "/images/lipofilling/caso1/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/lipofilling/caso1/tres-cuartos-antes.jpg", after: "/images/lipofilling/caso1/tres-cuartos-despues.jpg", view: "Vista 3/4" },
        { before: "/images/lipofilling/caso1/detalle-antes.jpg", after: "/images/lipofilling/caso1/detalle-despues.jpg", view: "Vista Detalle" }
      ]
    },
    {
      id: 2,
      title: "Lipofilling de Mejillas",
      age: "38 años",
      description: "Restauración de volumen en mejillas con técnica de lipofilling y células madre regenerativas.",
      images: [
        { before: "/images/lipofilling/caso2/frontal-antes.jpg", after: "/images/lipofilling/caso2/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/lipofilling/caso2/perfil-antes.jpg", after: "/images/lipofilling/caso2/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/lipofilling/caso2/tres-cuartos-antes.jpg", after: "/images/lipofilling/caso2/tres-cuartos-despues.jpg", view: "Vista 3/4" }
      ]
    },
    {
      id: 3,
      title: "Lipofilling Temporal y Ojeras",
      age: "45 años",
      description: "Tratamiento de hundimiento temporal y ojeras profundas con grasa enriquecida.",
      images: [
        { before: "/images/lipofilling/caso3/frontal-antes.jpg", after: "/images/lipofilling/caso3/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/lipofilling/caso3/perfil-antes.jpg", after: "/images/lipofilling/caso3/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/lipofilling/caso3/ojeras-antes.jpg", after: "/images/lipofilling/caso3/ojeras-despues.jpg", view: "Vista Ojeras" },
        { before: "/images/lipofilling/caso3/temporal-antes.jpg", after: "/images/lipofilling/caso3/temporal-despues.jpg", view: "Vista Temporal" }
      ]
    },
    // Casos 4-26 - Estructura base para completar
    ...Array.from({ length: 23 }, (_, index) => ({
      id: index + 4,
      title: `Lipofilling Facial Caso ${index + 4}`,
      age: `${35 + (index % 18)} años`,
      description: "Restauración de volumen facial con grasa autóloga enriquecida con células madre para resultados naturales y duraderos.",
      images: [
        { before: `/images/lipofilling/caso${index + 4}/frontal-antes.jpg`, after: `/images/lipofilling/caso${index + 4}/frontal-despues.jpg`, view: "Vista Frontal" },
        { before: `/images/lipofilling/caso${index + 4}/perfil-antes.jpg`, after: `/images/lipofilling/caso${index + 4}/perfil-despues.jpg`, view: "Vista Perfil" },
        { before: `/images/lipofilling/caso${index + 4}/tres-cuartos-antes.jpg`, after: `/images/lipofilling/caso${index + 4}/tres-cuartos-despues.jpg`, view: "Vista 3/4" }
      ]
    }))
  ];

  const currentCase = lipofillingCases[selectedCase];
  const currentImagePair = currentCase.images[selectedImage];

  const nextSlide = () => {
    setCurrentSlide((prev) => 
      prev >= lipofillingCases.length - 6 ? 0 : prev + 1
    );
  };

  const prevSlide = () => {
    setCurrentSlide((prev) => 
      prev === 0 ? Math.max(0, lipofillingCases.length - 6) : prev - 1
    );
  };
  ...
  const nextCase = () => {
    if (selectedCase < lipofillingCases.length - 1) {
      ...
      <div className="bg-gray-100 py-3 px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <select className="bg-gray-800 text-white px-4 py-2 rounded text-sm">
            <option>Lipofilling con Células Madre</option>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
            ...
            <div className="bg-blue-600 rounded-lg overflow-hidden">
              <div className="grid grid-cols-2">
                ...
                <div className="relative">
                  <div className="w-full h-96 bg-gradient-to-br from-pink-100 to-pink-200 flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
                        <span className="text-pink-600 font-bold text-lg">ANTES</span>
                      </div>
                      <span className="text-pink-800 font-medium text-lg">{currentImagePair.view}</span>
                      <p className="text-pink-700 text-sm mt-2">Caso #{currentCase.id}</p>
                    </div>
                  </div>
                </div>
                ...
                {/* Imagen DESPUÉS */}
                <div className="relative">
                  <div className="w-full h-96 bg-gradient-to-br from-rose-100 to-rose-200 flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
                        <span className="text-rose-600 font-bold text-lg">DESPUÉS</span>
                      </div>
                      <span className="text-rose-800 font-medium text-lg">{currentImagePair.view}</span>
                      <p className="text-rose-700 text-sm mt-2">Resultado</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {currentCase.images.map((imagePair, index) => (
                ...
                >
                  <div className="grid grid-cols-2 gap-0.5">
                    <div className="w-full h-12 bg-gradient-to-br from-pink-50 to-pink-100 flex items-center justify-center">
                      <span className="text-pink-600 text-xs font-bold">A</span>
                    </div>
                    <div className="w-full h-12 bg-gradient-to-br from-rose-50 to-rose-100 flex items-center justify-center">
                      <span className="text-rose-600 text-xs font-bold">D</span>
                    </div>
                  </div>
                  <div className="p-2">
        ...
        <div className="flex justify-between mb-8">
          ...
          <div className="text-sm text-gray-600 self-center">
            Caso {selectedCase + 1} de {lipofillingCases.length}
          </div>
          <button 
            onClick={nextCase}
            disabled={selectedCase === lipofillingCases.length - 1}
            className="bg-gray-200 text-gray-600 px-6 py-2 rounded text-sm hover:bg-gray-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Siguiente
          </button>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <div className="overflow-hidden">
            ...
            >
              {lipofillingCases.map((caso, index) => (
                <div 
                  key={caso.id}
                ...
                >
                  <div
                    ...
                    className={`bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all cursor-pointer transform hover:scale-105 ${
                      selectedCase === index ? 'ring-2 ring-pink-500' : ''
                    }`}
                  >
                    <div className="grid grid-cols-2">
                      <div className="w-full h-16 bg-gradient-to-br from-pink-50 to-pink-100 flex items-center justify-center">
                        <span className="text-pink-600 text-xs font-bold">ANTES</span>
                      </div>
                      <div className="w-full h-16 bg-gradient-to-br from-rose-50 to-rose-100 flex items-center justify-center">
                        <span className="text-rose-600 text-xs font-bold">DESPUÉS</span>
                      </div>
                    </div>
...
export default LipofillingPage;