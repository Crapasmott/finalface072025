...
// COMPONENTE PRINCIPAL DE MENTOPLASTIA
const MentoplastiaPage = () => {
  const [selectedCase, setSelectedCase] = useState(0);
  const [selectedImage, setSelectedImage] = useState(0);
  const [currentSlide, setCurrentSlide] = useState(0);

  // Datos de los 4 casos de Mentoplastia
  const mentoplastiaCases = [
    {
      id: 1,
      title: "Mentoplastia de Aumento",
      age: "35 años",
      description: "Aumento de mentón que mejora el perfil facial y crea armonía entre nariz, labios y mentón.",
      images: [
        { before: "/images/mentoplastia/caso1/frontal-antes.jpg", after: "/images/mentoplastia/caso1/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/mentoplastia/caso1/perfil-antes.jpg", after: "/images/mentoplastia/caso1/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/mentoplastia/caso1/tres-cuartos-antes.jpg", after: "/images/mentoplastia/caso1/tres-cuartos-despues.jpg", view: "Vista 3/4" },
        { before: "/images/mentoplastia/caso1/bajo-antes.jpg", after: "/images/mentoplastia/caso1/bajo-despues.jpg", view: "Vista Inferior" }
      ]
    },
    {
      id: 2,
      title: "Genioplastia de Avance",
      age: "29 años",
      description: "Cirugía ósea de mentón para corrección de retrognatismo y mejora del perfil.",
      images: [
        { before: "/images/mentoplastia/caso2/frontal-antes.jpg", after: "/images/mentoplastia/caso2/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/mentoplastia/caso2/perfil-antes.jpg", after: "/images/mentoplastia/caso2/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/mentoplastia/caso2/tres-cuartos-antes.jpg", after: "/images/mentoplastia/caso2/tres-cuartos-despues.jpg", view: "Vista 3/4" }
      ]
    },
    {
      id: 3,
      title: "Mentoplastia con Implante",
      age: "42 años",
      description: "Colocación de implante de mentón para proyección y definición del tercio inferior facial.",
      images: [
        { before: "/images/mentoplastia/caso3/frontal-antes.jpg", after: "/images/mentoplastia/caso3/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/mentoplastia/caso3/perfil-antes.jpg", after: "/images/mentoplastia/caso3/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/mentoplastia/caso3/bajo-antes.jpg", after: "/images/mentoplastia/caso3/bajo-despues.jpg", view: "Vista Inferior" },
        { before: "/images/mentoplastia/caso3/detalle-antes.jpg", after: "/images/mentoplastia/caso3/detalle-despues.jpg", view: "Vista Detalle" }
      ]
    },
    {
      id: 4,
      title: "Genioplastia de Reducción",
      age: "37 años",
      description: "Reducción ósea de mentón para corrección de prognatismo y equilibrio facial.",
      images: [
        { before: "/images/mentoplastia/caso4/frontal-antes.jpg", after: "/images/mentoplastia/caso4/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/mentoplastia/caso4/perfil-antes.jpg", after: "/images/mentoplastia/caso4/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/mentoplastia/caso4/tres-cuartos-antes.jpg", after: "/images/mentoplastia/caso4/tres-cuartos-despues.jpg", view: "Vista 3/4" }
      ]
    }
  ];

  const currentCase = mentoplastiaCases[selectedCase];
  const currentImagePair = currentCase.images[selectedImage];

  const nextSlide = () => {
    setCurrentSlide((prev) => 
      prev >= mentoplastiaCases.length - 4 ? 0 : prev + 1
    );
  };
  ...
  const nextCase = () => {
    if (selectedCase < mentoplastiaCases.length - 1) {
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="lg:col-span-4">
            <div className="bg-blue-600 rounded-lg overflow-hidden">
              <div className="grid grid-cols-2">
                  ...
                  <div className="w-full h-96 bg-gradient-to-br from-slate-100 to-slate-200 flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
                        <span className="text-slate-600 font-bold text-lg">ANTES</span>
                      </div>
                      <span className="text-slate-800 font-medium text-lg">{currentImagePair.view}</span>
                      <p className="text-slate-700 text-sm mt-2">Caso #{currentCase.id}</p>
                    </div>
                  </div>
                </div>
                ...
                {/* Imagen DESPUÉS */}
                <div className="relative">
                  <div className="w-full h-96 bg-gradient-to-br from-cyan-100 to-cyan-200 flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
                        <span className="text-cyan-600 font-bold text-lg">DESPUÉS</span>
                      </div>
                      <span className="text-cyan-800 font-medium text-lg">{currentImagePair.view}</span>
                      <p className="text-cyan-700 text-sm mt-2">Resultado</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {currentCase.images.map((imagePair, index) => (
                <button
                  ...
                  className={`w-full bg-white rounded-lg shadow-md overflow-hidden transition-all duration-200 ${
                    selectedImage === index 
                      ? 'ring-2 ring-slate-500 scale-105' 
                      : 'hover:scale-102 hover:shadow-lg'
                  }`}
                >
                  <div className="grid grid-cols-2 gap-0.5">
                    <div className="w-full h-12 bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center">
                      <span className="text-slate-600 text-xs font-bold">A</span>
                    </div>
                    <div className="w-full h-12 bg-gradient-to-br from-cyan-50 to-cyan-100 flex items-center justify-center">
                      <span className="text-cyan-600 text-xs font-bold">D</span>
                    </div>
                  </div>
                  <div className="p-2">
        ...
        <div className="flex justify-between mb-8">
          ...
          <div className="text-sm text-gray-600 self-center">
            Caso {selectedCase + 1} de {mentoplastiaCases.length}
          </div>
          <button 
            onClick={nextCase}
            disabled={selectedCase === mentoplastiaCases.length - 1}
            className="bg-gray-200 text-gray-600 px-6 py-2 rounded text-sm hover:bg-gray-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Siguiente
          </button>
        ...
        {/* Grid de casos relacionados - Solo 4 casos */}
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex space-x-2">
              <button 
                onClick={prevSlide}
                disabled={mentoplastiaCases.length <= 4}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {mentoplastiaCases.map((caso, index) => (
              <div 
                key={caso.id}
                className="w-full"
              >
                <div
                  ...
                  className={`bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all cursor-pointer transform hover:scale-105 ${
                    selectedCase === index ? 'ring-2 ring-slate-500' : ''
                  }`}
                >
                  <div className="grid grid-cols-2">
                    <div className="w-full h-16 bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center">
                      <span className="text-slate-600 text-xs font-bold">ANTES</span>
                    </div>
                    <div className="w-full h-16 bg-gradient-to-br from-cyan-50 to-cyan-100 flex items-center justify-center">
                      <span className="text-cyan-600 text-xs font-bold">DESPUÉS</span>
                    </div>
                  </div>
...
export default MentoplastiaPage;