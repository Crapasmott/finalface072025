...
// COMPONENTE PRINCIPAL DE LIFTING HAMACA
const LiftingHamacaPage = () => {
  const [selectedCase, setSelectedCase] = useState(0);
  const [selectedImage, setSelectedImage] = useState(0);
  const [currentSlide, setCurrentSlide] = useState(0);

  // Datos de los 32 casos de Lifting Facial Hamaca
  const liftingCases = [
    {
      id: 1,
      title: "Lifting Hamaca de Mejillas y Cuello",
      age: "52 años",
      description: "Rejuvenecimiento facial integral que reposiciona tejidos y elimina la flacidez con técnica mínimamente invasiva.",
      images: [
        ...
        { before: "/images/lifting/caso1/cuello-antes.jpg", after: "/images/lifting/caso1/cuello-despues.jpg", view: "Vista Cuello" }
      ]
    },
    {
      id: 2,
      title: "Mini Lifting Facial",
      age: "42 años",
      description: "Lifting facial mínimamente invasivo con técnica SMAS para rejuvenecimiento natural.",
      images: [
        { before: "/images/lifting/caso2/frontal-antes.jpg", after: "/images/lifting/caso2/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/lifting/caso2/perfil-antes.jpg", after: "/images/lifting/caso2/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/lifting/caso2/tres-cuartos-antes.jpg", after: "/images/lifting/caso2/tres-cuartos-despues.jpg", view: "Vista 3/4" }
      ]
    },
    {
      id: 3,
      ...
      age: "55 años",
      description: "Rejuvenecimiento específico del área cervical eliminando papada y flacidez.",
      images: [
        { before: "/images/lifting/caso3/frontal-antes.jpg", after: "/images/lifting/caso3/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/lifting/caso3/perfil-antes.jpg", after: "/images/lifting/caso3/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/lifting/caso3/cuello-antes.jpg", after: "/images/lifting/caso3/cuello-despues.jpg", view: "Vista Cuello" },
        { before: "/images/lifting/caso3/bajo-antes.jpg", after: "/images/lifting/caso3/bajo-despues.jpg", view: "Vista Inferior" }
      ]
    },
    // Casos 4-32 generados automáticamente
    ...Array.from({ length: 29 }, (_, index) => ({
      id: index + 4,
      title: `Lifting Facial Caso ${index + 4}`,
      age: `${45 + (index % 20)} años`,
      description: "Rejuvenecimiento facial que reposiciona tejidos, elimina flacidez y restaura la juventud del rostro.",
      images: [
        { before: `/images/lifting/caso${index + 4}/frontal-antes.jpg`, after: `/images/lifting/caso${index + 4}/frontal-despues.jpg`, view: "Vista Frontal" },
        { before: `/images/lifting/caso${index + 4}/perfil-antes.jpg`, after: `/images/lifting/caso${index + 4}/perfil-despues.jpg`, view: "Vista Perfil" },
        { before: `/images/lifting/caso${index + 4}/tres-cuartos-antes.jpg`, after: `/images/lifting/caso${index + 4}/tres-cuartos-despues.jpg`, view: "Vista 3/4" }
      ]
    }))
  ];

  const currentCase = liftingCases[selectedCase];
  const currentImagePair = currentCase.images[selectedImage];

  const nextSlide = () => {
    setCurrentSlide((prev) => 
      prev >= liftingCases.length - 6 ? 0 : prev + 1
    );
  };

  const prevSlide = () => {
    setCurrentSlide((prev) => 
      prev === 0 ? liftingCases.length - 6 : prev - 1
    );
  };
  ...
  const nextCase = () => {
    if (selectedCase < liftingCases.length - 1) {
      ...
      <div className="bg-gray-100 py-3 px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <select className="bg-gray-800 text-white px-4 py-2 rounded text-sm">
            <option>Lifting Facial Hamaca</option>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
              ...
              <div className="grid grid-cols-2">
                  ...
                  <div className="w-full h-96 bg-gradient-to-br from-orange-100 to-orange-200 flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
                        <span className="text-orange-600 font-bold text-lg">ANTES</span>
                      </div>
                      <span className="text-orange-800 font-medium text-lg">{currentImagePair.view}</span>
                      <p className="text-orange-700 text-sm mt-2">Caso #{currentCase.id}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative">
                  <div className="w-full h-96 bg-gradient-to-br from-emerald-100 to-emerald-200 flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
                        <span className="text-emerald-600 font-bold text-lg">DESPUÉS</span>
                      </div>
                      <span className="text-emerald-800 font-medium text-lg">{currentImagePair.view}</span>
                      <p className="text-emerald-700 text-sm mt-2">Resultado</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {currentCase.images.map((imagePair, index) => (
                ...
                >
                  <div className="grid grid-cols-2 gap-0.5">
                    <div className="w-full h-12 bg-gradient-to-br from-orange-50 to-orange-100 flex items-center justify-center">
        ...
        <div className="flex justify-between mb-8">
          ...
          <div className="text-sm text-gray-600 self-center">
            Caso {selectedCase + 1} de {liftingCases.length}
          </div>
          <button 
            onClick={nextCase}
            disabled={selectedCase === liftingCases.length - 1}
            className="bg-gray-200 text-gray-600 px-6 py-2 rounded text-sm hover:bg-gray-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Siguiente
          </button>
                ...
                >
                  <div
                    ...
                    className={`bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all cursor-pointer transform hover:scale-105 ${
                      selectedCase === index ? 'ring-2 ring-orange-500' : ''
                    }`}
                  >
                    <div className="grid grid-cols-2">
                      <div className="w-full h-16 bg-gradient-to-br from-orange-50 to-orange-100 flex items-center justify-center">
                        <span className="text-orange-600 text-xs font-bold">ANTES</span>
                      </div>
                      <div className="w-full h-16 bg-gradient-to-br from-emerald-50 to-emerald-100 flex items-center justify-center">
                        <span className="text-emerald-600 text-xs font-bold">DESPUÉS</span>
                      </div>
                    </div>
...
export default LiftingHamacaPage;