...
// ==========================================
// COMPONENTE PRINCIPAL BLEFAROPLASTIA - INICIA AQUÍ
// ==========================================
const BlefaroplastiaPage = () => {
  ...
  // Datos de los 25 casos de Blefaroplastia
  const blefaroplastiaCases = [
    {
      id: 1,
      title: "Blefaroplastia Superior",
      age: "45 años",
      description: "Rejuvenecimiento de párpados superiores que elimina el exceso de piel y grasa.",
      images: [
        ...
        { before: "/images/blefaroplastia/caso1/ojos-cerrados-antes.jpg", after: "/images/blefaroplastia/caso1/ojos-cerrados-despues.jpg", view: "Ojos Cerrados" },
        ...
        { before: "/images/blefaroplastia/caso1/tres-cuartos-antes.jpg", after: "/images/blefaroplastia/caso1/tres-cuartos-despues.jpg", view: "Vista 3/4" }
      ]
    },
    {
      id: 2,
      ...
      age: "50 años",
      description: "Eliminación de bolsas palpebrales inferiores y rejuvenecimiento de la mirada.",
      images: [
        { before: "/images/blefaroplastia/caso2/frontal-antes.jpg", after: "/images/blefaroplastia/caso2/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/blefaroplastia/caso2/perfil-antes.jpg", after: "/images/blefaroplastia/caso2/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/blefaroplastia/caso2/tres-cuartos-antes.jpg", after: "/images/blefaroplastia/caso2/tres-cuartos-despues.jpg", view: "Vista 3/4" }
      ]
    },
    {
      id: 3,
      title: "Blefaroplastia 360°",
      age: "48 años",
      description: "Tratamiento completo de párpados superiores e inferiores para rejuvenecimiento integral.",
      images: [
        { before: "/images/blefaroplastia/caso3/frontal-antes.jpg", after: "/images/blefaroplastia/caso3/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/blefaroplastia/caso3/ojos-cerrados-antes.jpg", after: "/images/blefaroplastia/caso3/ojos-cerrados-despues.jpg", view: "Ojos Cerrados" },
        { before: "/images/blefaroplastia/caso3/perfil-antes.jpg", after: "/images/blefaroplastia/caso3/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/blefaroplastia/caso3/detalle-antes.jpg", after: "/images/blefaroplastia/caso3/detalle-despues.jpg", view: "Vista Detalle" }
      ]
    },
    // Casos 4-25 generados automáticamente
    ...Array.from({ length: 22 }, (_, index) => ({
      id: index + 4,
      title: `Blefaroplastia Caso ${index + 4}`,
      age: `${42 + (index % 15)} años`,
      description: "Rejuvenecimiento de párpados que elimina las bolsas y exceso de piel para una mirada más joven.",
      images: [
        { before: `/images/blefaroplastia/caso${index + 4}/frontal-antes.jpg`, after: `/images/blefaroplastia/caso${index + 4}/frontal-despues.jpg`, view: "Vista Frontal" },
        { before: `/images/blefaroplastia/caso${index + 4}/perfil-antes.jpg`, after: `/images/blefaroplastia/caso${index + 4}/perfil-despues.jpg`, view: "Vista Perfil" },
        { before: `/images/blefaroplastia/caso${index + 4}/detalle-antes.jpg`, after: `/images/blefaroplastia/caso${index + 4}/detalle-despues.jpg`, view: "Vista Detalle" }
      ]
    }))
  ];

  const currentCase = blefaroplastiaCases[selectedCase];
  const currentImagePair = currentCase.images[selectedImage];

  const nextSlide = () => {
    setCurrentSlide((prev) => 
      prev >= blefaroplastiaCases.length - 6 ? 0 : prev + 1
    );
  };

  const prevSlide = () => {
    setCurrentSlide((prev) => 
      prev === 0 ? blefaroplastiaCases.length - 6 : prev - 1
    );
  };
  ...
  const nextCase = () => {
    if (selectedCase < blefaroplastiaCases.length - 1) {
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
            ...
            <div className="bg-blue-600 rounded-lg overflow-hidden">
              <div className="grid grid-cols-2">
                ...
                <div className="relative">
                  <div className="w-full h-96 bg-gradient-to-br from-purple-100 to-purple-200 flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
                        <span className="text-purple-600 font-bold text-lg">ANTES</span>
                      </div>
                      <span className="text-purple-800 font-medium text-lg">{currentImagePair.view}</span>
                      <p className="text-purple-700 text-sm mt-2">Caso #{currentCase.id}</p>
                    </div>
                  </div>
                </div>
              ...
              {currentCase.images.map((imagePair, index) => (
                ...
                >
                  <div className="grid grid-cols-2 gap-0.5">
                    <div className="w-full h-12 bg-gradient-to-br from-purple-50 to-purple-100 flex items-center justify-center">
        ...
        <div className="flex justify-between mb-8">
          ...
          <div className="text-sm text-gray-600 self-center">
            Caso {selectedCase + 1} de {blefaroplastiaCases.length}
          </div>
          <button 
            onClick={nextCase}
            disabled={selectedCase === blefaroplastiaCases.length - 1}
            className="bg-gray-200 text-gray-600 px-6 py-2 rounded text-sm hover:bg-gray-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Siguiente
          </button>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <div className="overflow-hidden">
            ...
            >
              {blefaroplastiaCases.map((caso, index) => (
                <div 
                  key={caso.id}
                ...
                >
                  ...
                  >
                    <div className="grid grid-cols-2">
                      <div className="w-full h-16 bg-gradient-to-br from-purple-50 to-purple-100 flex items-center justify-center">
                        <span className="text-purple-600 text-xs font-bold">ANTES</span>
                      </div>
