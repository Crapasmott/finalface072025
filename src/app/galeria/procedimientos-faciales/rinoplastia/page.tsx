...
// COMPONENTE PRINCIPAL DE RINOPLASTIA
const RinoplastiaPage = () => {
  const [selectedCase, setSelectedCase] = useState(0);
  const [selectedImage, setSelectedImage] = useState(0);
  const [currentSlide, setCurrentSlide] = useState(0);

  // Datos de los 17 casos de Rinoplastia
  const rinoplastiaCases = [
    {
      id: 1,
    ...
    },
    {
      ...
      age: "31 años",
      description: "Técnica especializada respetando características étnicas del paciente.",
      images: [
        { before: "/images/rinoplastia/caso2/frontal-antes.jpg", after: "/images/rinoplastia/caso2/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/rinoplastia/caso2/perfil-antes.jpg", after: "/images/rinoplastia/caso2/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/rinoplastia/caso2/tres-cuartos-antes.jpg", after: "/images/rinoplastia/caso2/tres-cuartos-despues.jpg", view: "Vista 3/4" }
      ]
    },
    {
      id: 3,
      title: "Rinoplastia de Reducción",
      age: "26 años",
      description: "Reducción de giba nasal y refinamiento de punta.",
      images: [
        { before: "/images/rinoplastia/caso3/frontal-antes.jpg", after: "/images/rinoplastia/caso3/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/rinoplastia/caso3/perfil-antes.jpg", after: "/images/rinoplastia/caso3/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/rinoplastia/caso3/tres-cuartos-antes.jpg", after: "/images/rinoplastia/caso3/tres-cuartos-despues.jpg", view: "Vista 3/4" },
        { before: "/images/rinoplastia/caso3/basal-antes.jpg", after: "/images/rinoplastia/caso3/basal-despues.jpg", view: "Vista Basal" }
      ]
    },
    {
      id: 4,
      ...
      images: [
        { before: "/images/rinoplastia/caso4/frontal-antes.jpg", after: "/images/rinoplastia/caso4/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/rinoplastia/caso4/perfil-antes.jpg", after: "/images/rinoplastia/caso4/perfil-despues.jpg", view: "Vista Perfil" }
      ]
    },
    {
      id: 5,
      title: "Rinoplastia de Aumento",
      age: "29 años",
      description: "Aumento de dorso nasal y proyección de punta.",
      images: [
        { before: "/images/rinoplastia/caso5/frontal-antes.jpg", after: "/images/rinoplastia/caso5/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/rinoplastia/caso5/perfil-antes.jpg", after: "/images/rinoplastia/caso5/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/rinoplastia/caso5/tres-cuartos-antes.jpg", after: "/images/rinoplastia/caso5/tres-cuartos-despues.jpg", view: "Vista 3/4" }
      ]
    },
    {
      id: 6,
      ...
      age: "35 años",
      description: "Refinamiento nasal masculino manteniendo características viriles.",
      images: [
        { before: "/images/rinoplastia/caso6/frontal-antes.jpg", after: "/images/rinoplastia/caso6/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/rinoplastia/caso6/perfil-antes.jpg", after: "/images/rinoplastia/caso6/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/rinoplastia/caso6/tres-cuartos-antes.jpg", after: "/images/rinoplastia/caso6/tres-cuartos-despues.jpg", view: "Vista 3/4" },
        { before: "/images/rinoplastia/caso6/basal-antes.jpg", after: "/images/rinoplastia/caso6/basal-despues.jpg", view: "Vista Basal" }
      ]
    },
    {
      id: 7,
      title: "Rinoplastia Piezo",
      age: "24 años",
      description: "Técnica piezo para mínima inflamación y recuperación rápida.",
      images: [
        { before: "/images/rinoplastia/caso7/frontal-antes.jpg", after: "/images/rinoplastia/caso7/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/rinoplastia/caso7/perfil-antes.jpg", after: "/images/rinoplastia/caso7/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/rinoplastia/caso7/tres-cuartos-antes.jpg", after: "/images/rinoplastia/caso7/tres-cuartos-despues.jpg", view: "Vista 3/4" }
      ]
    },
    {
      id: 8,
      ...
      age: "38 años",
      description: "Corrección estética y funcional para mejorar respiración.",
      images: [
        { before: "/images/rinoplastia/caso8/frontal-antes.jpg", after: "/images/rinoplastia/caso8/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/rinoplastia/caso8/perfil-antes.jpg", after: "/images/rinoplastia/caso8/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/rinoplastia/caso8/basal-antes.jpg", after: "/images/rinoplastia/caso8/basal-despues.jpg", view: "Vista Basal" }
      ]
    },
    {
      id: 9,
      title: "Rinoplastia de Punta",
      age: "27 años",
      description: "Refinamiento específico de punta nasal con preservación del dorso.",
      images: [
        { before: "/images/rinoplastia/caso9/frontal-antes.jpg", after: "/images/rinoplastia/caso9/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/rinoplastia/caso9/perfil-antes.jpg", after: "/images/rinoplastia/caso9/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/rinoplastia/caso9/tres-cuartos-antes.jpg", after: "/images/rinoplastia/caso9/tres-cuartos-despues.jpg", view: "Vista 3/4" },
        { before: "/images/rinoplastia/caso9/basal-antes.jpg", after: "/images/rinoplastia/caso9/basal-despues.jpg", view: "Vista Basal" }
      ]
    },
    {
      id: 10,
      title: "Rinoplastia Natural",
      age: "30 años",
      description: "Resultado natural que respeta las proporciones faciales.",
      images: [
        { before: "/images/rinoplastia/caso10/frontal-antes.jpg", after: "/images/rinoplastia/caso10/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/rinoplastia/caso10/perfil-antes.jpg", after: "/images/rinoplastia/caso10/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/rinoplastia/caso10/tres-cuartos-antes.jpg", after: "/images/rinoplastia/caso10/tres-cuartos-despues.jpg", view: "Vista 3/4" }
      ]
    },
    {
      id: 11,
      title: "Rinoplastia Conservadora",
      age: "32 años",
      description: "Técnica conservadora para cambios sutiles y naturales.",
      images: [
        { before: "/images/rinoplastia/caso11/frontal-antes.jpg", after: "/images/rinoplastia/caso11/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/rinoplastia/caso11/perfil-antes.jpg", after: "/images/rinoplastia/caso11/perfil-despues.jpg", view: "Vista Perfil" }
      ]
    },
    {
      id: 12,
      ...
      age: "25 años",
      description: "Técnica cerrada sin cicatrices externas visibles.",
      images: [
        { before: "/images/rinoplastia/caso12/frontal-antes.jpg", after: "/images/rinoplastia/caso12/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/rinoplastia/caso12/perfil-antes.jpg", after: "/images/rinoplastia/caso12/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/rinoplastia/caso12/tres-cuartos-antes.jpg", after: "/images/rinoplastia/caso12/tres-cuartos-despues.jpg", view: "Vista 3/4" },
        { before: "/images/rinoplastia/caso12/basal-antes.jpg", after: "/images/rinoplastia/caso12/basal-despues.jpg", view: "Vista Basal" }
      ]
    },
    {
      id: 13,
      ...
      age: "34 años",
      description: "Técnica abierta para casos complejos con mayor precisión.",
      images: [
        { before: "/images/rinoplastia/caso13/frontal-antes.jpg", after: "/images/rinoplastia/caso13/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/rinoplastia/caso13/perfil-antes.jpg", after: "/images/rinoplastia/caso13/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/rinoplastia/caso13/tres-cuartos-antes.jpg", after: "/images/rinoplastia/caso13/tres-cuartos-despues.jpg", view: "Vista 3/4" }
      ]
    },
    {
      id: 14,
      title: "Rinoplastia Teen",
      age: "18 años",
      description: "Rinoplastia para pacientes jóvenes con técnica especializada.",
      images: [
        { before: "/images/rinoplastia/caso14/frontal-antes.jpg", after: "/images/rinoplastia/caso14/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/rinoplastia/caso14/perfil-antes.jpg", after: "/images/rinoplastia/caso14/perfil-despues.jpg", view: "Vista Perfil" }
      ]
    },
    {
      id: 15,
      title: "Rinoplastia Asimétrica",
      age: "36 años",
      description: "Corrección de asimetría nasal para balance facial.",
      images: [
        { before: "/images/rinoplastia/caso15/frontal-antes.jpg", after: "/images/rinoplastia/caso15/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/rinoplastia/caso15/perfil-antes.jpg", after: "/images/rinoplastia/caso15/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/rinoplastia/caso15/tres-cuartos-antes.jpg", after: "/images/rinoplastia/caso15/tres-cuartos-despues.jpg", view: "Vista 3/4" },
        { before: "/images/rinoplastia/caso15/basal-antes.jpg", after: "/images/rinoplastia/caso15/basal-despues.jpg", view: "Vista Basal" }
      ]
    },
    {
      id: 16,
      title: "Rinoplastia Post-Trauma",
      age: "41 años",
      description: "Reconstrucción nasal después de traumatismo.",
      images: [
        { before: "/images/rinoplastia/caso16/frontal-antes.jpg", after: "/images/rinoplastia/caso16/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/rinoplastia/caso16/perfil-antes.jpg", after: "/images/rinoplastia/caso16/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/rinoplastia/caso16/tres-cuartos-antes.jpg", after: "/images/rinoplastia/caso16/tres-cuartos-despues.jpg", view: "Vista 3/4" }
      ]
    },
    {
      id: 17,
      title: "Rinoplastia de Precisión",
      age: "23 años",
      description: "Técnica de alta precisión para resultados excepcionales.",
      images: [
        { before: "/images/rinoplastia/caso17/frontal-antes.jpg", after: "/images/rinoplastia/caso17/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/rinoplastia/caso17/perfil-antes.jpg", after: "/images/rinoplastia/caso17/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/rinoplastia/caso17/tres-cuartos-antes.jpg", after: "/images/rinoplastia/caso17/tres-cuartos-despues.jpg", view: "Vista 3/4" },
        { before: "/images/rinoplastia/caso17/basal-antes.jpg", after: "/images/rinoplastia/caso17/basal-despues.jpg", view: "Vista Basal" }
      ]
    }
  ];

  const currentCase = rinoplastiaCases[selectedCase];
  const currentImagePair = currentCase.images[selectedImage];

  const nextSlide = () => {
    setCurrentSlide((prev) => 
      prev >= rinoplastiaCases.length - 6 ? 0 : prev + 1
    );
  };

  const prevSlide = () => {
    setCurrentSlide((prev) => 
      prev === 0 ? rinoplastiaCases.length - 6 : prev - 1
    );
  };
  ...
  const nextCase = () => {
    if (selectedCase < rinoplastiaCases.length - 1) {
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
              ...
              {currentCase.images.map((imagePair, index) => (
                ...
                >
                  <div className="grid grid-cols-2 gap-0.5">
                    <div className="w-full h-12 bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center">
                      <span className="text-blue-600 text-xs font-bold">A</span>
                    </div>
                    <div className="w-full h-12 bg-gradient-to-br from-green-50 to-green-100 flex items-center justify-center">
        ...
        <div className="flex justify-between mb-8">
          ...
          <div className="text-sm text-gray-600 self-center">
            Caso {selectedCase + 1} de {rinoplastiaCases.length}
          </div>
          <button 
            onClick={nextCase}
            disabled={selectedCase === rinoplastiaCases.length - 1}
            className="bg-gray-200 text-gray-600 px-6 py-2 rounded text-sm hover:bg-gray-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Siguiente
          </button>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <div className="overflow-hidden">
            ...
            >
              {rinoplastiaCases.map((caso, index) => (
                <div 
                  key={caso.id}
...
export default RinoplastiaPage;