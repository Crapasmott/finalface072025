...
// ==========================================
// HEADER PROFESIONAL COMPLETO - INICIA AQUÍ
// ==========================================
const Header = () => {
...
// ==========================================
// FOOTER PROFESIONAL COMPLETO - INICIA AQUÍ  
// ==========================================
const Footer = () => {
...
// ==========================================
// COMPONENTE PRINCIPAL ELEVACIÓN CEJAS - INICIA AQUÍ
// ==========================================
const ElevacionCejasPage = () => {
  const [selectedCase, setSelectedCase] = useState(0);
  const [selectedImage, setSelectedImage] = useState(0);
  const [currentSlide, setCurrentSlide] = useState(0);

  // Datos de los 20 casos de Elevación Cola de Cejas
  const elevacionCejasCases = [
    {
      id: 1,
      title: "Elevación Cola de Cejas Bilateral",
      age: "42 años",
      description: "Rejuvenecimiento de la zona superior del rostro mediante elevación de cola de cejas para una mirada más joven y expresiva.",
      images: [
        { before: "/images/elevacion-cejas/caso1/frontal-antes.jpg", after: "/images/elevacion-cejas/caso1/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/elevacion-cejas/caso1/ojos-cerrados-antes.jpg", after: "/images/elevacion-cejas/caso1/ojos-cerrados-despues.jpg", view: "Ojos Cerrados" },
        { before: "/images/elevacion-cejas/caso1/perfil-antes.jpg", after: "/images/elevacion-cejas/caso1/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/elevacion-cejas/caso1/tres-cuartos-antes.jpg", after: "/images/elevacion-cejas/caso1/tres-cuartos-despues.jpg", view: "Vista 3/4" }
      ]
    },
    {
      id: 2,
      title: "Elevación Temporal de Cejas",
      age: "38 años",
      description: "Técnica mínimamente invasiva para elevar específicamente la cola de las cejas.",
      images: [
        { before: "/images/elevacion-cejas/caso2/frontal-antes.jpg", after: "/images/elevacion-cejas/caso2/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/elevacion-cejas/caso2/perfil-antes.jpg", after: "/images/elevacion-cejas/caso2/perfil-despues.jpg", view: "Vista Perfil" },
        { before: "/images/elevacion-cejas/caso2/detalle-antes.jpg", after: "/images/elevacion-cejas/caso2/detalle-despues.jpg", view: "Vista Detalle" }
      ]
    },
    {
      id: 3,
      title: "Corrección de Ptosis de Cejas",
      age: "48 años",
      description: "Corrección de caída de cejas mediante técnica de elevación conservadora.",
      images: [
        { before: "/images/elevacion-cejas/caso3/frontal-antes.jpg", after: "/images/elevacion-cejas/caso3/frontal-despues.jpg", view: "Vista Frontal" },
        { before: "/images/elevacion-cejas/caso3/ojos-cerrados-antes.jpg", after: "/images/elevacion-cejas/caso3/ojos-cerrados-despues.jpg", view: "Ojos Cerrados" },
        { before: "/images/elevacion-cejas/caso3/perfil-antes.jpg", after: "/images/elevacion-cejas/caso3/perfil-despues.jpg", view: "Vista Perfil" }
      ]
    },
    // Casos 4-20 - Estructura base para completar
    ...Array.from({ length: 17 }, (_, index) => ({
      id: index + 4,
      title: `Elevación Cola de Cejas Caso ${index + 4}`,
      age: `${35 + (index % 20)} años`,
      description: "Rejuvenecimiento de la zona superior mediante elevación precisa de cola de cejas para una expresión más juvenil.",
      images: [
        { before: `/images/elevacion-cejas/caso${index + 4}/frontal-antes.jpg`, after: `/images/elevacion-cejas/caso${index + 4}/frontal-despues.jpg`, view: "Vista Frontal" },
        { before: `/images/elevacion-cejas/caso${index + 4}/perfil-antes.jpg`, after: `/images/elevacion-cejas/caso${index + 4}/perfil-despues.jpg`, view: "Vista Perfil" },
        { before: `/images/elevacion-cejas/caso${index + 4}/detalle-antes.jpg`, after: `/images/elevacion-cejas/caso${index + 4}/detalle-despues.jpg`, view: "Vista Detalle" }
      ]
    }))
  ];

  const currentCase = elevacionCejasCases[selectedCase];
  const currentImagePair = currentCase.images[selectedImage];

  const nextSlide = () => {
    setCurrentSlide((prev) => 
      prev >= elevacionCejasCases.length - 6 ? 0 : prev + 1
    );
  };

  const prevSlide = () => {
    setCurrentSlide((prev) => 
      prev === 0 ? elevacionCejasCases.length - 6 : prev - 1
    );
  };
  ...
  const nextCase = () => {
    if (selectedCase < elevacionCejasCases.length - 1) {
      ...
      <div className="bg-gray-100 py-3 px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <select className="bg-gray-800 text-white px-4 py-2 rounded text-sm">
            <option>Elevación Cola de Cejas</option>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="lg:col-span-4">
            <div className="bg-blue-600 rounded-lg overflow-hidden">
              <div className="grid grid-cols-2">
                  ...
                  <div className="w-full h-96 bg-gradient-to-br from-indigo-100 to-indigo-200 flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
                        <span className="text-indigo-600 font-bold text-lg">ANTES</span>
                      </div>
                      <span className="text-indigo-800 font-medium text-lg">{currentImagePair.view}</span>
                      <p className="text-indigo-700 text-sm mt-2">Caso #{currentCase.id}</p>
                    </div>
                  </div>
                </div>
                ...
                {/* Imagen DESPUÉS */}
                <div className="relative">
                  <div className="w-full h-96 bg-gradient-to-br from-violet-100 to-violet-200 flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
                        <span className="text-violet-600 font-bold text-lg">DESPUÉS</span>
                      </div>
                      <span className="text-violet-800 font-medium text-lg">{currentImagePair.view}</span>
                      <p className="text-violet-700 text-sm mt-2">Resultado</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {currentCase.images.map((imagePair, index) => (
                ...
                >
                  <div className="grid grid-cols-2 gap-0.5">
                    <div className="w-full h-12 bg-gradient-to-br from-indigo-50 to-indigo-100 flex items-center justify-center">
                      <span className="text-indigo-600 text-xs font-bold">A</span>
                    </div>
                    <div className="w-full h-12 bg-gradient-to-br from-violet-50 to-violet-100 flex items-center justify-center">
                      <span className="text-violet-600 text-xs font-bold">D</span>
                    </div>
                  </div>
                  <div className="p-2">
        ...
        <div className="flex justify-between mb-8">
          ...
          <div className="text-sm text-gray-600 self-center">
            Caso {selectedCase + 1} de {elevacionCejasCases.length}
          </div>
          <button 
            onClick={nextCase}
            disabled={selectedCase === elevacionCejasCases.length - 1}
            className="bg-gray-200 text-gray-600 px-6 py-2 rounded text-sm hover:bg-gray-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Siguiente
          </button>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <div className="overflow-hidden">
            ...
            >
              {elevacionCejasCases.map((caso, index) => (
                <div 
                  key={caso.id}
                ...
                >
                  ...
                  >
                    <div className="grid grid-cols-2">
                      <div className="w-full h-16 bg-gradient-to-br from-indigo-50 to-indigo-100 flex items-center justify-center">
                        <span className="text-indigo-600 text-xs font-bold">ANTES</span>
                      </div>
                      <div className="w-full h-16 bg-gradient-to-br from-violet-50 to-violet-100 flex items-center justify-center">
                        <span className="text-violet-600 text-xs font-bold">DESPUÉS</span>
                      </div>
                    </div>
...
export default ElevacionCejasPage;